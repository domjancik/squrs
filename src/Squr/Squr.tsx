...
function Squr({side = 100}: Props): ReactElement {
    ...
    return (
        <div style={
            {
                ...{borderRadius: '0.5em', padding: '1em', boxSizing: 'border-box'},
                ...sqr(side),
                ...dim(res),
            }
        }>
            <input style={{fontFamily: 'monospace', borderRadius: '0.3em', padding: '1em', boxSizing: 'border-box', border: 'none', width: '90%'}} type="text" value={expression} onChange={e => setExpression(e.target.value)} />
